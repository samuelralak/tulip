class PaintsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @paint.save
        format.html { redirect_to paints_path, notice: 'Paint was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @paint.update(paint_params)
        format.html { redirect_to paints_path, notice: 'Paint was successfully updated.' }
  ...
  private
    ...
    def paint_params
      params.require(:paint).permit(:month, :year, :amount, :site_id)
    end
end
